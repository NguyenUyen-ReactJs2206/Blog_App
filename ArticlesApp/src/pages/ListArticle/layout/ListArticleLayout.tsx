...
export default function ListArticleLayout() {
  ...
  const [isYourFeed, setIsYourFeed] = useState(true)
          ...
          <div className='relative grid grid-cols-1 text-left md:mx-6 md:grid-cols-12'>
            <div className='md:col-span-9'>
              {!isAuthenticated ? (
                ...
                <div className=''>
                  <div className='flex'>
                    <button className='border-b-1 px-4 py-2' onClick={handleYourFeed}>
                      Your Feed
                    </button>
                    <button className='border-b-1 px-4 py-2' onClick={handleGlobalFeed}>
                      Global Feed
                    </button>
                  </div>
